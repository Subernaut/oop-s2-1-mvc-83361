...
namespace Library.MVC.Data.Migrations
{
    ...
    [Migration("20260404222941_RedoAllEntities")]
    partial class RedoAllEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Library.Domain.Assignment", b =>
                {
                    ...
                    b.Property<int?>("AssignmentResultId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AssignmentResultId1");
            ...
            modelBuilder.Entity("Library.Domain.Assignment", b =>
                {
                    b.HasOne("Library.Domain.AssignmentResult", "AssignmentResult")
                        .WithMany()
                        .HasForeignKey("AssignmentResultId1");
            ...
            modelBuilder.Entity("Library.Domain.Exam", b =>
                {
                    ...
                    b.HasOne("Library.Domain.ExamResult", "ExamResult")
                        .WithMany()
